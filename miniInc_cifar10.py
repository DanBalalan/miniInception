...
def inception_Module(inputs):
    ...
    tower_one = Conv2D(10, (1,1), activation='relu', border_mode='same')(tower_one)

    tower_two = Conv2D(10, (1,1), activation='relu', border_mode='same')(inputs)
    tower_two = Conv2D(10, (3,3), activation='relu', border_mode='same')(tower_two)

    tower_three = Conv2D(10, (1,1), activation='relu', border_mode='same')(inputs)
    tower_three = Conv2D(10, (5,5), activation='relu', border_mode='same')(tower_three)
